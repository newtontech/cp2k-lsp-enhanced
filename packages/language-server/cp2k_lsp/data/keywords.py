...
CP2K_KEYWORDS: Dict[str, KeywordInfo] = {
    ...
    "TEMPERATURE": KeywordInfo(
        name="TEMPERATURE", description="Target temperature for thermostat", keyword_type=KeywordType.REAL, default=300.0, units=["K"]
    ),
    # KIND keywords
    "ELEMENT": KeywordInfo(name="ELEMENT", description="Chemical element symbol", keyword_type=KeywordType.STRING, required=True),
    "BASIS_SET": KeywordInfo(name="BASIS_SET", description="Basis set for this kind", keyword_type=KeywordType.STRING, required=True),
