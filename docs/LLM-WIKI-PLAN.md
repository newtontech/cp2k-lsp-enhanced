...
`sources/cp2k/0.9.1.json` records checksums, sizes, versions, and confidence for
repo-local evidence. Large generated registries stay in their existing project
paths and are referenced from the manifest instead of being duplicated under
`raw/assets/`.
...
- [x] 创建 index.md 导航
- [x] 创建 log.md 变更日志
- [x] 创建 sources/manifest.schema.json 和 sources/cp2k/0.9.1.json
- [x] 创建 scripts/wiki_lint.py
- [x] Git 提交和 PR
