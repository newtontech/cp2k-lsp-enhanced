...
```bash
cp2k-lsp-tool check path/to/input --format json
cp2k-lsp-tool context path/to/input --format json
cp2k-lsp-tool complete path/to/input --format json
cp2k-lsp-tool hover path/to/input --format json
cp2k-lsp-tool symbols path/to/input --format json
cp2k-lsp-tool fix path/to/input --format json
```
