...
```bash
git tag testpypi-v0.9.2rc1
git push origin testpypi-v0.9.2rc1
```
...
```bash
python -m venv /tmp/cp2k-lsp-enhanced-testpypi
/tmp/cp2k-lsp-enhanced-testpypi/bin/python -m pip install --upgrade pip
/tmp/cp2k-lsp-enhanced-testpypi/bin/pip install \
  --index-url https://test.pypi.org/simple/ \
  --extra-index-url https://pypi.org/simple/ \
  cp2k-lsp-enhanced==0.9.2rc1
```
